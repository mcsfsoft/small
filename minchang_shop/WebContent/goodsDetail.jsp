...
<body>
	<%@ include file="header.jsp"%>
	   ...
	   <ol class="breadcrumb">
		  ...
		  <li><a href="#">手机</a></li>
		  <li class="active"><a href="#">${goods.name}</a></li>
	   </ol>
   </div>
		...
		<div class="row">
		  <div class="col-xs-6 col-md-6">
		    <a href="#" class="thumbnail">
		      <img src="image/${goods.picture}"  width="560" height="560"  alt="###" />
		    </a>
		  </div>
		  <div class="col-xs-6 col-md-6">
			  ...
			  <div class="panel-body">
			    ...
			    <div style="margin-left: 10px;">
				   ...
				   <p>市场价格:&nbsp;&nbsp;&nbsp;<span class="text-danger" style="font-size: 15px;">${goods.price}</span>&nbsp;&nbsp;&nbsp;<span class="glyphicon glyphicon-yen"></span></p> 
				    ...
				    <p>详细介绍:</p>
				    <p>&nbsp;&nbsp;${goods.intro}</p>
				    <a href="cart2?action=addToCart&id=${goods.id}" class="btn btn-warning">加入购物车&nbsp;&nbsp;&nbsp;<span class="glyphicon glyphicon-shopping-cart"></span></a>&nbsp;&nbsp;&nbsp;
