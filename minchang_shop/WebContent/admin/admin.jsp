...
<script type="text/javascript">
	<!--会员管理-->
	function userList(){
		var div1=document.getElementById("iframe2");
		div1.src="http://127.0.0.1:8080/minchang_shop/admin/userList.jsp";
	}
	<!--无效会员-->
	function invalidUser(){
		var div1=document.getElementById("iframe2");
		div1.src="http://127.0.0.1:8080/minchang_shop/admin/invalidUser.jsp";
	}
	<!--商品分类-->
	function showGoodsType(){
		var div1=document.getElementById("iframe2");
		div1.src="http://127.0.0.1:8080/minchang_shop/admin/showGoodsType.jsp";
	}
	<!--商品分类添加-->
	function addGoodsType(){
		var div1=document.getElementById("iframe2");
		div1.src="http://127.0.0.1:8080/minchang_shop/admin/addGoodsType.jsp";
	}
	<!--商品查看-->
	function showGoods(){
		var div1=document.getElementById("iframe2");
		div1.src="http://127.0.0.1:8080/minchang_shop/admin/showGoods.jsp";
	}
	<!--商品添加-->
	function addGoods(){
		var div1=document.getElementById("iframe2");
		div1.src="http://127.0.0.1:8080/minchang_shop/admin/addGoods.jsp";
	}
	<!---->
	function showOrder(){
		var div1=document.getElementById("iframe2");
		div1.src="http://127.0.0.1:8080/minchang_shop/admin/showAllOrder.jsp";
	}
			...
			<ul class="nav panel-group" id="myPanel">
				...
				<li class="panel">
					...
					<ul id="sub1" class="nav collapse panel-collapse">
						<li>
							<a href="javascript:userList()" id="userList"> 
	<span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;<b>会员管理</b>
							</a>
						</li>
						<li>
							<a href="javascript:invalidUser()" id="invalid"><!-- 无效会员 -->
				...
				<li class="panel">
					...
					<ul id="sub3" class="nav panel-collapse collapse">
						<li>
							<a href="javascript:showGoodsType()" id="showGoodsType"> 
								<span class="glyphicon glyphicon-record"></span>&nbsp;&nbsp;查看商品分类
							</a>
						</li>
						<li>
							<a href="javascript:addGoodsType()" id="addGoodsType"> 
								<span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;添加商品分类
							</a>
						</li>
						<li>
							<a href="javascript:showGoods()" id="showGoods" > 
								<span class="glyphicon glyphicon-record"></span>&nbsp;&nbsp;查看商品
							</a>
						</li>
						<li>
							<a href="javascript:addGoods()" id="addGoods"> 
				...
				<li class="panel">
					...
					<ul id="sub2" class="nav panel-collapse collapse">
						<li>
							<a href="javascript:showOrder()" id="showOrder"> 
		...
		<div class="page_main">
			...
			<iframe class="dv_content" id="iframe2" src="" frameborder="0" scrolling="no">		
			</iframe>
		</div>
	</div>
</body>
